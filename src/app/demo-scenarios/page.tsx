...
import { Users, Truck, BarChart3, MessageCircle, Package } from 'lucide-react'
          ...
          {bots.map((bot) => {
            ...
            return (
              <button
                ...
                className={`w-full px-4 py-4 flex items-start gap-3 hover:bg-[#202C33] transition-colors border-b border-[#2A3942] ${

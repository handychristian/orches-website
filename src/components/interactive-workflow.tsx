...
export default function InteractiveWorkflow({ onTimeSaved }: InteractiveWorkflowProps) {
  ...
  // Auto-scroll chat container when new message arrives (with delay for smoother effect)
  useEffect(() => {
    if (chatContainerRef.current && whatsappMessages.length > 0) {
      // Add delay to make scroll more noticeable and readable
...
🤖 *Auto-generated by OrchesAI Assistant*`,
  ...
  const sendInvoiceToWhatsApp = () => {
    ...
    // No auto-transition to complete - stay on whatsapp step to show both chat and summary
  }
...
⚡ *Invoice created in ${timeElapsed.toFixed(1)}s vs 45min manual process*`
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Main Content */}
      {currentStep !== 'whatsapp' && currentStep !== 'complete' && (
        ...
        >
          <Card className="p-6 shadow-lg border-0 bg-white">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Left Column - WhatsApp Chat Interface */}
              <div className="order-2 lg:order-1">
                {/* WhatsApp Header - Client POV */}
                <div className="bg-[#075E54] text-white p-3 rounded-t-lg flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gray-400 rounded-full flex items-center justify-center overflow-hidden shadow-lg">
                  ...
                  <div className="flex-1">
                    <div className="font-medium text-sm">
                      {extractClientName(clientMessage)} (Client)
                    </div>
                ...
                <div
                  ...
                  className="bg-[#E5DDD5] bg-opacity-30 p-4 h-96 overflow-y-auto scroll-smooth"
                  style={{
              ...
              {/* Right Column - Workflow Complete Summary */}
      ...
      {/* Complete Step (if needed separately) */}

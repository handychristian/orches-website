...
import { MessageCircle, Package, Users, Truck, BarChart3, X } from 'lucide-react'
...
export default function MultiBotDemoTabs() {
  ...
  return (
    <section id="demo" className="w-full bg-white py-24">
      ...
      <div className="sticky top-0 z-10 bg-white/95 backdrop-blur-sm py-4 -mx-4 px-4 mb-6 shadow-sm">
        <div className="overflow-x-auto">
          <div className="flex gap-2 min-w-max md:justify-center pb-2">
          {bots.map((bot) => {
            const Icon = bot.icon

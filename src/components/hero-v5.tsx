  ...
  return (
    <section ref={containerRef} className="min-h-screen flex items-center justify-center bg-white pt-32 pb-24 relative overflow-hidden">
      ...
      >
        ...
        {/* Main Headline with Cliffhanger */}
        <motion.div
        ...
        {/* Sensory Emotional Bridge */}
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.2, ease: [0.16, 1, 0.3, 1] }}
          className="text-[21px] sm:text-[24px] text-[#1D1D1F] mb-6 max-w-4xl mx-auto font-normal leading-[1.4]"
        >
          Bayangkan: <span className="font-semibold text-black">Jam 5 sore. Laptop tertutup.</span> Anak Anda tanya, "Papa/Mama bisa main?" <span className="font-semibold text-black">Dan Anda bilang YA.</span>
        </motion.p>
        ...
        <motion.p
          ...
          className="text-[17px] text-[#86868B] mb-4 max-w-4xl mx-auto font-normal leading-[1.5]"
        >
          Tidak ada lagi WhatsApp jam 2 pagi. Tidak ada lagi copy-paste sampai pagi. Tidak ada lagi weekend dihabiskan untuk update Excel.
        </motion.p>
        ...
        <motion.p
          ...
          className="text-[19px] text-black mb-16 max-w-4xl mx-auto font-semibold leading-[1.5]"
        >
          Scroll ke bawah untuk lihat bagaimana 73 bisnis Indonesia mengotomasi 1,247 jam kerja setiap bulan →
        </motion.p>

        {/* Stats with Vivid Context */}
        <motion.div
        ...
        {/* Trust indicators with Strong Urgency */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <p className="text-[13px] text-[#86868B]">
            Free consultation 30 menit • Zero-Risk Promise • Setup dalam 16 hari
          </p>
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-50 border border-green-200 rounded-full">
            <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
            <span className="text-[13px] font-medium text-green-700">Hanya 3 slot tersisa di Mei 2025</span>
          </div>
        </motion.div>
      </motion.div>
    </section>
